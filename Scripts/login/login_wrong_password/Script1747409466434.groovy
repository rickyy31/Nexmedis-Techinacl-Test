...
WebUI.setEncryptedText(findTestObject('login/input_password'), 'f80LxPuIJeFXmJuqTmmGTKyqiK6cNnHU')

WebUI.click(findTestObject('login/button_solid'))

WebUI.waitForElementVisible(findTestObject('login/popup_notif'), 2)

WebUI.verifyElementVisible(findTestObject('login/popup_notif'))
